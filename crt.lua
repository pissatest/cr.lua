...
-- MODIFIED: Separated Evo units, added separate Auto Attack toggle, removed backup unit functionality, implemented unlocked unit filtering, and added usage logging.
